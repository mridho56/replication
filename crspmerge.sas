...
%macro crspmerge_po (s=,start=,end=,sfvars=,sevars=,filters=,final_ds=);
...
%if (%sysfunc(libref(crsp))) %then %do; 
        ...
        libname crsp "D:\WRDS\crsp";  
/*E:\Data for SAS\Data collected from WRDS\wrds\crsp\sasdata\a_stock*/
%end;
